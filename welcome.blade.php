...
<div class="container-xxl bg-white p-0">
            ...
            <div class="container my-5 py-5">
                <div class="row align-items-center g-5">
                    <div class="col-lg-6 text-center text-lg-start">
                        ...
                        <a href="#my-order" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Order Now</a>
                    </div>
    ...
    <!-- My Order Start -->
    <div class="container-xxl py-5" id="my-order">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <form action="/submit-order" method="POST">
                <div class="row g-4">
                    ...
                    <div class="col-lg-12">
                        <div class="form-floating">
                            <textarea class="form-control" id="order-details" name="order-details" placeholder="Order Details" style="height: 150px;" required></textarea>
                            <label for="order-details">Order Details</label>
                        </div>
                    </div>
                    <div class="col-lg-12 text-center">
                        <button class="btn btn-primary py-3 px-5" type="submit">Submit Order</button>
                    </div>
                </div>
            </form>
        </div>
